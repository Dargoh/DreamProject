...
public abstract class DreamCommand implements CommandExecutor, TabExecutor {
    ...
    public DreamCommand(String command) {
        this(command, null, null, null, null);
    }

    public DreamCommand(String command, String usage) {
        this(command, usage, null, null, null);
    }

    public DreamCommand(String command, String usage, String description) {
        this(command, usage, description, null, null);
    }

    public DreamCommand(String command, String usage, String description, String permissionMessage) {
        this(command, usage, description, permissionMessage, null);
    }

    public DreamCommand(String command, String usage, String description, List<String> aliases) {
        this(command, usage, description, null, aliases);
    }

    public DreamCommand(String command, String usage, String description, String permissionMessage, List<String> aliases) {
    ...
    private final class ReflectCommand extends Command {
        private DreamCommand exe = null;

        protected ReflectCommand(String command) { super(command); }
        public void setExecutor(DreamCommand exe) { this.exe = exe; }
